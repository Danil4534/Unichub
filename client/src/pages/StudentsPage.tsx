...
const StudentsPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex h-[calc(100vh-180px)] w-full flex-col gap-2 p-4 rounded-2xl border border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-900 ">
        ...
        {filteredResults.length == 0 ? (
          <div className="w-full h-[calc(100vh-200px)] flex justify-center items-center flex-col gap-3">
            {store.theme === "dark" ? (
              <Image src={LogoIconLight} className="animate-rotate size-10" />
            ) : (
              <Image src={LogoIconBlack} className="animate-rotate" />
          ...
          <div className="grid grid-cols-4 gap-4 overflow-y-auto h-[calc(100vh-200px)] w-6/6 p-4">
            {filteredResults.length > 0 &&
